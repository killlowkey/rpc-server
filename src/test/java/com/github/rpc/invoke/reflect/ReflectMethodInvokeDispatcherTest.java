...
public class ReflectMethodInvokeDispatcherTest {
    ...
    public void methodInvokeTest() throws Throwable {
        ...
        assertThrows(IllegalArgumentException.class, () -> dispatcher.invoke("hasTwoPrimaryValue"));
        assertThrows(IllegalArgumentException.class, () -> dispatcher.invoke("hasTwoPrimaryValue", 10));
